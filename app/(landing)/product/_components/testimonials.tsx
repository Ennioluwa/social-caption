...
const Testimonials = () => {
  return (
    <section className=" py-32 pb-20 bg-white text-dark flex flex-col gap-20 ">
      ...
      <div className=" flex flex-col lg:flex-row gap-8 pl-8 lg:pl-12">
        <div className=" space-y-2 flex-1">
          ...
          <p className=" text-[#615861]">
            ...
            est a, mattis tellus. Sed dignissim. eu turpis molestie, dictum est
            a, mattis tellus. Sed dignissim, dictum est a, mattis tellus. Sed
            dignissim.
          </p>
        </div>
